 ...
 * @author rubens
 */
public class POBehaviorEconomyRushSimple extends BehaviorEconomyRushSimple {

    public POBehaviorEconomyRushSimple(BasicExpandedConfigurableScript bec, PhysicalGameState pgs, Player p, GameState gs, int player) {
