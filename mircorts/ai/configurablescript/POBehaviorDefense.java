 ...
 * @author rubens
 */
public class POBehaviorDefense extends BehaviorDefense {

	public POBehaviorDefense(BasicExpandedConfigurableScript bec, PhysicalGameState pgs, Player p, GameState gs, int player) {
	...
	public void meleeUnitBehavior(Unit u, Player p, GameState gs) {
		...
		if (closestEnemy != null) {
			...
			{
				if (fartestDistance!=-1 && (mybase < pgs.getHeight()/ratioDefense)) {
